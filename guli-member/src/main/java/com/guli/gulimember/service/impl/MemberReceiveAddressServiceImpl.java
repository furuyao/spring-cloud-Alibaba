...
import com.guli.gulimember.dao.MemberReceiveAddressDao;
...
public class MemberReceiveAddressServiceImpl extends ServiceImpl<MemberReceiveAddressDao, MemberReceiveAddressEntity> implements MemberReceiveAddressService {
    ...
    public List<MemberReceiveAddressEntity> getAddress(Long memeberId) {
        ...
        List<MemberReceiveAddressEntity> member_id = this.list(new QueryWrapper<MemberReceiveAddressEntity>().eq("member_id", memeberId));
        return member_id;
    }
